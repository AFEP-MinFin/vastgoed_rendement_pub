...
run_standard_scenario <-
  function(houses, parameters) {
    ...
    if(parameters$middenhuur_reform == T) {
      ...
      houses$huur_oud = 'nee'
      wws_parameters = list(bA1 = 1, bA91 = 11041, bA91b = 172, bA93i = 0.33, wws_reform = 1)
      houses <-
        houses %>%
        calculate_wws_points(.,wws_reform = wws_parameters$wws_reform, bA1 = wws_parameters$bA1, bA91 = wws_parameters$bA91, bA91b = wws_parameters$bA91b) %>%
    ...
    if(parameters$middenhuur_reform == F) {
      houses$investor = 'part_box3'
      houses$huur_oud = 'nee'
      wws_parameters = list(bA1 = 1, bA91 = 11041, bA91b = 172, bA93i = 0.33, wws_reform = 0)
      houses <-
        houses %>%
        calculate_wws_points(.,wws_reform = wws_parameters$wws_reform, bA1 = wws_parameters$bA1, bA91 = wws_parameters$bA91, bA91b = wws_parameters$bA91b) %>%
